...
class LocationEnum(Enum):
    SC_1 = 0
    SC_1_TAKEIN_2 = 1
    SC_1_PROVIDE_LOANER_2 = 2
    SC_2_TAKEIN_2 = 3
    SC_2_PROVIDE_LOANER_2 = 4
    PICKUP_2_LOANER = 5
...
def create_distance_callback(data):
    ...
    _distances[LocationEnum.SC_1.value][LocationEnum.SC_1_TAKEIN_2.value] = 1000
    _distances[LocationEnum.SC_1.value][LocationEnum.SC_1_PROVIDE_LOANER_2.value] = 30
    _distances[LocationEnum.SC_1.value][LocationEnum.SC_2_TAKEIN_2.value] = 1000
    _distances[LocationEnum.SC_1.value][LocationEnum.SC_2_PROVIDE_LOANER_2.value] = 20
    _distances[LocationEnum.SC_1.value][LocationEnum.PICKUP_2_LOANER.value] = 1000
    ...
    _distances[LocationEnum.SC_2_TAKEIN_2.value][LocationEnum.PICKUP_2_LOANER.value] = 1000  # need to get loaner car first
