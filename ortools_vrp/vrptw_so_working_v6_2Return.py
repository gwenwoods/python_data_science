...
class LocationEnum(Enum):
    ...
    PICKUP_1 = 6
    RETURN_0 = 7
    RETURN_1 = 8 # WEN TODO: problem is need to go back to depot in the middle of the route, how about refuel
...
def create_distance_callback(data):
    ...
    _distances[LocationEnum.SC_1.value][LocationEnum.SC_1_RETURN_0.value] = 0
    ...
    _distances[LocationEnum.SC_1_TAKEIN_0.value][LocationEnum.SC_1_RETURN_0.value] = 0
    ...
    _distances[LocationEnum.SC_1_TAKEIN_1.value][LocationEnum.SC_1_RETURN_0.value] = 0
    ...
    _distances[LocationEnum.SC_1_RETURN_1.value][LocationEnum.SC_1_TAKEIN_0.value] = 0
    _distances[LocationEnum.SC_1_RETURN_1.value][LocationEnum.SC_1_TAKEIN_1.value] = 0
    _distances[LocationEnum.SC_1_RETURN_1.value][LocationEnum.SC_1_RETURN_0.value] = 0
    _distances[LocationEnum.SC_1_RETURN_1.value][LocationEnum.SC_1_RETURN_1.value] = 0
    _distances[LocationEnum.SC_1_RETURN_1.value][LocationEnum.PICKUP_0.value] = 100
    _distances[LocationEnum.SC_1_RETURN_1.value][LocationEnum.PICKUP_1.value] = 100
    _distances[LocationEnum.SC_1_RETURN_1.value][LocationEnum.RETURN_0.value] = 100
    ...
    _distances[LocationEnum.PICKUP_0.value][LocationEnum.SC_1_TAKEIN_1.value] = 25
    _distances[LocationEnum.PICKUP_0.value][LocationEnum.SC_1_RETURN_0.value] = 1000 # (should be 1000)
    _distances[LocationEnum.PICKUP_0.value][LocationEnum.SC_1_RETURN_1.value] = 1000  # (should be 1000)
    ...
    _distances[LocationEnum.PICKUP_1.value][LocationEnum.SC_1_TAKEIN_0.value] = 0
    _distances[LocationEnum.PICKUP_1.value][LocationEnum.SC_1_TAKEIN_1.value] = 5
    _distances[LocationEnum.PICKUP_1.value][LocationEnum.SC_1_RETURN_0.value] = 1000
    ...
    _distances[LocationEnum.RETURN_0.value][LocationEnum.SC_1_RETURN_0.value] = 40
    ...
    _distances[LocationEnum.RETURN_1.value][LocationEnum.SC_1_TAKEIN_0.value] = 100
    _distances[LocationEnum.RETURN_1.value][LocationEnum.SC_1_TAKEIN_1.value] = 100
    _distances[LocationEnum.RETURN_1.value][LocationEnum.SC_1_RETURN_0.value] = 100
    _distances[LocationEnum.RETURN_1.value][LocationEnum.SC_1_RETURN_1.value] = 5
    _distances[LocationEnum.RETURN_1.value][LocationEnum.PICKUP_0.value] = 10
    _distances[LocationEnum.RETURN_1.value][LocationEnum.PICKUP_1.value] = 5
    _distances[LocationEnum.RETURN_1.value][LocationEnum.RETURN_0.value] = 1000
    _distances[LocationEnum.RETURN_1.value][LocationEnum.RETURN_1.value] = 1000
...
def main():
  ...
  routing.AddPickupAndDelivery(LocationEnum.SC_1_RETURN_0.value, LocationEnum.RETURN_0.value)
