...
def create_distance_callback(data):
    ...
    _distances[LocationEnum.SC_1_TAKEIN_0.value][LocationEnum.SC_1_TAKEIN_1.value] = 1000
    ...
    _distances[LocationEnum.SC_1_TAKEIN_1.value][LocationEnum.SC_1_TAKEIN_0.value] = 1000
    _distances[LocationEnum.SC_1_TAKEIN_1.value][LocationEnum.SC_1_TAKEIN_1.value] = 0
    _distances[LocationEnum.SC_1_TAKEIN_1.value][LocationEnum.SC_1_TAKEIN_2.value] = 1000
    ...
    _distances[LocationEnum.SC_1_RETURN_1.value][LocationEnum.SC_1_PROVIDE_LOANER_2.value] = 1000  #
    ...
    _distances[LocationEnum.SC_1_RETURN_1.value][LocationEnum.SC_2_PROVIDE_LOANER_2.value] = 1000  # p t
...
def main():
  ...
  #routing.AddDisjunction([LocationEnum.SC_1_RETURN_1.value, LocationEnum.SC_2_RETURN_0.value])
