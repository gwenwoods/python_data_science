...
def create_distance_callback(data):
    ...
    _distances[LocationEnum.SC_1_RETURN_0.value][LocationEnum.PICKUP_0.value] = 1000
    _distances[LocationEnum.SC_1_RETURN_0.value][LocationEnum.PICKUP_1.value] = 1000
    ...
    _distances[LocationEnum.PICKUP_1.value][LocationEnum.SC_1_TAKEIN_0.value] = 1000
