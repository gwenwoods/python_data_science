...
class LocationEnum(Enum):
    ...
    PICKUP_2_LOANER = 16
    RETURN_0 = 17
    RETURN_1 = 18 # WEN TODO: problem is need to go back to depot in the middle of the route, how about refuel
...
def create_data_model():
    ...
    time_windows = \
            [(0, 0), (60, 160), (95,160),
             (90,160), (0,50),           # SC_1_TAKEIN_2, SC_1_PROVIDE_LOANER_2,
             (0,90), #SC_1_RETURN_1
             (6, 160), (95,160), (80, 160), (0, 45), (0,60),
             (15, 15), (20, 20), (40, 40), # Wen: speicalist starting working time
...
def create_distance_callback(data):
    ...
    _distances[LocationEnum.SC_1.value][LocationEnum.SC_2_TAKEIN_0.value] = 0
    _distances[LocationEnum.SC_1.value][LocationEnum.SC_2_TAKEIN_1.value] = 0
    _distances[LocationEnum.SC_1.value][LocationEnum.SC_2_TAKEIN_2.value] = 0 # 0?
    _distances[LocationEnum.SC_1.value][LocationEnum.SC_2_PROVIDE_LOANER_2.value] = 0
    _distances[LocationEnum.SC_1.value][LocationEnum.SC_2_RETURN_0.value] = 0 #public transportation (fail at 65)
    ...
    _distances[LocationEnum.SC_1.value][LocationEnum.PICKUP_0.value] = 0 # 0?
    _distances[LocationEnum.SC_1.value][LocationEnum.PICKUP_1.value] = 0 # 0?
    _distances[LocationEnum.SC_1.value][LocationEnum.PICKUP_2_LOANER.value] = 0  # 0?
    _distances[LocationEnum.SC_1.value][LocationEnum.RETURN_0.value] = 0
    _distances[LocationEnum.SC_1.value][LocationEnum.RETURN_1.value] = 0
    ...
    _distances[LocationEnum.SC_1_TAKEIN_0.value][LocationEnum.SC_1_TAKEIN_1.value] = NOT_CONNECTED
    _distances[LocationEnum.SC_1_TAKEIN_0.value][LocationEnum.SC_1_TAKEIN_2.value] = NOT_CONNECTED # 0?
    ...
    _distances[LocationEnum.SC_1_TAKEIN_0.value][LocationEnum.SC_2_TAKEIN_0.value] = NOT_CONNECTED
    _distances[LocationEnum.SC_1_TAKEIN_0.value][LocationEnum.SC_2_TAKEIN_1.value] = NOT_CONNECTED
    _distances[LocationEnum.SC_1_TAKEIN_0.value][LocationEnum.SC_2_TAKEIN_2.value] = NOT_CONNECTED
    ...
    _distances[LocationEnum.SC_1_TAKEIN_0.value][LocationEnum.V0_DEFAULT.value] = NOT_CONNECTED
    _distances[LocationEnum.SC_1_TAKEIN_0.value][LocationEnum.V1_DEFAULT.value] = NOT_CONNECTED
    _distances[LocationEnum.SC_1_TAKEIN_0.value][LocationEnum.V2_DEFAULT.value] = NOT_CONNECTED
    _distances[LocationEnum.SC_1_TAKEIN_0.value][LocationEnum.PICKUP_0.value] = NOT_CONNECTED
    _distances[LocationEnum.SC_1_TAKEIN_0.value][LocationEnum.PICKUP_1.value] = NOT_CONNECTED
    _distances[LocationEnum.SC_1_TAKEIN_0.value][LocationEnum.PICKUP_2_LOANER.value] = NOT_CONNECTED
    _distances[LocationEnum.SC_1_TAKEIN_0.value][LocationEnum.RETURN_0.value] = NOT_CONNECTED
    _distances[LocationEnum.SC_1_TAKEIN_0.value][LocationEnum.RETURN_1.value] = NOT_CONNECTED

    _distances[LocationEnum.SC_1_TAKEIN_1.value][LocationEnum.SC_1.value] = 0
    _distances[LocationEnum.SC_1_TAKEIN_1.value][LocationEnum.SC_1_TAKEIN_0.value] = NOT_CONNECTED
    _distances[LocationEnum.SC_1_TAKEIN_1.value][LocationEnum.SC_1_TAKEIN_1.value] = 0
    _distances[LocationEnum.SC_1_TAKEIN_1.value][LocationEnum.SC_1_TAKEIN_2.value] = NOT_CONNECTED
    ...
    _distances[LocationEnum.SC_1_TAKEIN_1.value][LocationEnum.SC_2_TAKEIN_0.value] = NOT_CONNECTED
    _distances[LocationEnum.SC_1_TAKEIN_1.value][LocationEnum.SC_2_TAKEIN_1.value] = NOT_CONNECTED
    _distances[LocationEnum.SC_1_TAKEIN_1.value][LocationEnum.SC_2_TAKEIN_2.value] = NOT_CONNECTED
    ...
    _distances[LocationEnum.SC_1_TAKEIN_1.value][LocationEnum.V0_DEFAULT.value] = NOT_CONNECTED
    _distances[LocationEnum.SC_1_TAKEIN_1.value][LocationEnum.V1_DEFAULT.value] = NOT_CONNECTED
    _distances[LocationEnum.SC_1_TAKEIN_1.value][LocationEnum.V2_DEFAULT.value] = NOT_CONNECTED
    _distances[LocationEnum.SC_1_TAKEIN_1.value][LocationEnum.PICKUP_0.value] = NOT_CONNECTED
    _distances[LocationEnum.SC_1_TAKEIN_1.value][LocationEnum.PICKUP_1.value] = NOT_CONNECTED
    _distances[LocationEnum.SC_1_TAKEIN_1.value][LocationEnum.PICKUP_2_LOANER.value] = NOT_CONNECTED
    _distances[LocationEnum.SC_1_TAKEIN_1.value][LocationEnum.RETURN_0.value] = NOT_CONNECTED
    _distances[LocationEnum.SC_1_TAKEIN_1.value][LocationEnum.RETURN_1.value] = NOT_CONNECTED

    _distances[LocationEnum.SC_1_TAKEIN_2.value][LocationEnum.SC_1.value] = 0
    _distances[LocationEnum.SC_1_TAKEIN_2.value][LocationEnum.SC_1_TAKEIN_0.value] = NOT_CONNECTED # 0?
    _distances[LocationEnum.SC_1_TAKEIN_2.value][LocationEnum.SC_1_TAKEIN_1.value] = NOT_CONNECTED # 0?
    _distances[LocationEnum.SC_1_TAKEIN_2.value][LocationEnum.SC_1_TAKEIN_2.value] = 0
    _distances[LocationEnum.SC_1_TAKEIN_2.value][LocationEnum.SC_1_PROVIDE_LOANER_2.value] = NOT_CONNECTED  #
    _distances[LocationEnum.SC_1_TAKEIN_2.value][LocationEnum.SC_1_RETURN_1.value] = 40 # PT
    _distances[LocationEnum.SC_1_TAKEIN_2.value][LocationEnum.SC_2_TAKEIN_0.value] = NOT_CONNECTED
    _distances[LocationEnum.SC_1_TAKEIN_2.value][LocationEnum.SC_2_TAKEIN_1.value] = NOT_CONNECTED
    _distances[LocationEnum.SC_1_TAKEIN_2.value][LocationEnum.SC_2_TAKEIN_2.value] = NOT_CONNECTED
    _distances[LocationEnum.SC_1_TAKEIN_2.value][LocationEnum.SC_2_PROVIDE_LOANER_2.value] = 10
    _distances[LocationEnum.SC_1_TAKEIN_2.value][LocationEnum.SC_2_RETURN_0.value] = 20
    _distances[LocationEnum.SC_1_TAKEIN_2.value][LocationEnum.V0_DEFAULT.value] = NOT_CONNECTED
    _distances[LocationEnum.SC_1_TAKEIN_2.value][LocationEnum.V1_DEFAULT.value] = NOT_CONNECTED
    _distances[LocationEnum.SC_1_TAKEIN_2.value][LocationEnum.V2_DEFAULT.value] = NOT_CONNECTED
    ...
    _distances[LocationEnum.SC_1_TAKEIN_2.value][LocationEnum.PICKUP_2_LOANER.value] = NOT_CONNECTED # need to get loaner car first
    _distances[LocationEnum.SC_1_TAKEIN_2.value][LocationEnum.RETURN_0.value] = NOT_CONNECTED
    _distances[LocationEnum.SC_1_TAKEIN_2.value][LocationEnum.RETURN_1.value] = NOT_CONNECTED
    ...
    _distances[LocationEnum.SC_1_RETURN_1.value][LocationEnum.SC_1.value] = NOT_CONNECTED #???
    _distances[LocationEnum.SC_1_RETURN_1.value][LocationEnum.SC_1_TAKEIN_0.value] = NOT_CONNECTED
    _distances[LocationEnum.SC_1_RETURN_1.value][LocationEnum.SC_1_TAKEIN_1.value] = NOT_CONNECTED
    _distances[LocationEnum.SC_1_RETURN_1.value][LocationEnum.SC_1_TAKEIN_2.value] = NOT_CONNECTED
    _distances[LocationEnum.SC_1_RETURN_1.value][LocationEnum.SC_1_PROVIDE_LOANER_2.value] = NOT_CONNECTED  #
    _distances[LocationEnum.SC_1_RETURN_1.value][LocationEnum.SC_1_RETURN_1.value] = 0
    _distances[LocationEnum.SC_1_RETURN_1.value][LocationEnum.SC_2_TAKEIN_0.value] = NOT_CONNECTED
    _distances[LocationEnum.SC_1_RETURN_1.value][LocationEnum.SC_2_TAKEIN_1.value] = NOT_CONNECTED
    _distances[LocationEnum.SC_1_RETURN_1.value][LocationEnum.SC_2_TAKEIN_2.value] = NOT_CONNECTED
    _distances[LocationEnum.SC_1_RETURN_1.value][LocationEnum.SC_2_PROVIDE_LOANER_2.value] = NOT_CONNECTED  # p t
    _distances[LocationEnum.SC_1_RETURN_1.value][LocationEnum.SC_2_RETURN_0.value] = NOT_CONNECTED
    _distances[LocationEnum.SC_1_RETURN_1.value][LocationEnum.V0_DEFAULT.value] = NOT_CONNECTED
    _distances[LocationEnum.SC_1_RETURN_1.value][LocationEnum.V1_DEFAULT.value] = NOT_CONNECTED
    _distances[LocationEnum.SC_1_RETURN_1.value][LocationEnum.V2_DEFAULT.value] = NOT_CONNECTED
    _distances[LocationEnum.SC_1_RETURN_1.value][LocationEnum.PICKUP_0.value] = NOT_CONNECTED
    _distances[LocationEnum.SC_1_RETURN_1.value][LocationEnum.PICKUP_1.value] = NOT_CONNECTED
    _distances[LocationEnum.SC_1_RETURN_1.value][LocationEnum.PICKUP_2_LOANER.value] = NOT_CONNECTED
    _distances[LocationEnum.SC_1_RETURN_1.value][LocationEnum.RETURN_0.value] = NOT_CONNECTED
...
#-------
    ...
    _distances[LocationEnum.SC_2_TAKEIN_0.value][LocationEnum.SC_1_PROVIDE_LOANER_2.value] = 20
    _distances[LocationEnum.SC_2_TAKEIN_0.value][LocationEnum.SC_1_RETURN_1.value] = 70 #public transportation
    _distances[LocationEnum.SC_2_TAKEIN_0.value][LocationEnum.SC_2_TAKEIN_0.value] = 1000
    _distances[LocationEnum.SC_2_TAKEIN_0.value][LocationEnum.SC_2_TAKEIN_1.value] = 1000
    ...
    _distances[LocationEnum.SC_2_TAKEIN_1.value][LocationEnum.SC_1_PROVIDE_LOANER_2.value] = 30
    _distances[LocationEnum.SC_2_TAKEIN_1.value][LocationEnum.SC_1_RETURN_1.value] = 30 #public transportation
                # we know the return 1 appt, so we know when we should start from sc_1, which becomes the arrival time for sc2 ->sc1
    _distances[LocationEnum.SC_2_TAKEIN_1.value][LocationEnum.SC_2_TAKEIN_0.value] = 1000
    _distances[LocationEnum.SC_2_TAKEIN_1.value][LocationEnum.SC_2_TAKEIN_1.value] = 1000
    ...
    _distances[LocationEnum.SC_2_TAKEIN_2.value][LocationEnum.SC_1_PROVIDE_LOANER_2.value] = 1000  # PT
    ...
    _distances[LocationEnum.SC_2_TAKEIN_2.value][LocationEnum.SC_2_PROVIDE_LOANER_2.value] = 1000
    ...
    _distances[LocationEnum.SC_2_TAKEIN_2.value][LocationEnum.PICKUP_1.value] = 40
    ...
    _distances[LocationEnum.SC_2_PROVIDE_LOANER_2.value][
        LocationEnum.PICKUP_2_LOANER.value] = 15  # need to get loaner car first
    ...
    _distances[LocationEnum.SC_2_RETURN_0.value][LocationEnum.RETURN_0.value] = 15
    ...
    # _distances[LocationEnum.PICKUP_2.value][LocationEnum.SC_1.value] = 0
    # _distances[LocationEnum.PICKUP_2.value][LocationEnum.SC_1_TAKEIN_0.value] = 1000 #different incidents have differetn travel time to the same SC
    # _distances[LocationEnum.PICKUP_2.value][LocationEnum.SC_1_TAKEIN_1.value] = 1000
    # _distances[LocationEnum.PICKUP_2.value][LocationEnum.SC_1_TAKEIN_2.value] = 10
    # _distances[LocationEnum.PICKUP_2.value][LocationEnum.SC_1_PROVIDE_LOANER_2.value] = 1000
    # _distances[LocationEnum.PICKUP_2.value][LocationEnum.SC_1_RETURN_1.value] = 1000
    # _distances[LocationEnum.PICKUP_2.value][LocationEnum.SC_2.value] = 1000
    # _distances[LocationEnum.PICKUP_2.value][LocationEnum.SC_2_TAKEIN_0.value] = 1000
    # _distances[LocationEnum.PICKUP_2.value][LocationEnum.SC_2_TAKEIN_1.value] = 1000
    # _distances[LocationEnum.PICKUP_2.value][LocationEnum.SC_2_TAKEIN_2.value] = 15
    # _distances[LocationEnum.PICKUP_2.value][LocationEnum.SC_2_PROVIDE_LOANER_2.value] = 1000
    # _distances[LocationEnum.PICKUP_2.value][LocationEnum.SC_2_RETURN_0.value] = 1000
    # _distances[LocationEnum.PICKUP_2.value][LocationEnum.V0_DEFAULT.value] = 1000
    # _distances[LocationEnum.PICKUP_2.value][LocationEnum.V1_DEFAULT.value] = 1000
    # _distances[LocationEnum.PICKUP_2.value][LocationEnum.V2_DEFAULT.value] = 1000
    # _distances[LocationEnum.PICKUP_2.value][LocationEnum.PICKUP_0.value] = 1000
    # _distances[LocationEnum.PICKUP_2.value][LocationEnum.PICKUP_1.value] = 1000
    # _distances[LocationEnum.PICKUP_2.value][LocationEnum.PICKUP_2_LOANER.value] = 1000
    # _distances[LocationEnum.PICKUP_2.value][LocationEnum.PICKUP_2.value] = 0
    # _distances[LocationEnum.PICKUP_2.value][LocationEnum.RETURN_0.value] = 1000
    # _distances[LocationEnum.PICKUP_2.value][LocationEnum.RETURN_1.value] = 1000
    ...
    _distances[LocationEnum.RETURN_0.value][LocationEnum.SC_2_RETURN_0.value] = 1000
    ...
    _distances[LocationEnum.RETURN_0.value][LocationEnum.PICKUP_0.value] = 1000 # pickup_0 earlier than return )
...
def main():
  ...
  routing.AddDisjunction([LocationEnum.SC_1_TAKEIN_1.value, LocationEnum.SC_2_TAKEIN_1.value])
  routing.AddDisjunction([LocationEnum.SC_1_TAKEIN_2.value, LocationEnum.SC_2_TAKEIN_2.value])

 #routing.AddDisjunction([LocationEnum.SC_1_RETURN_1.value], 10000)

  #routing.AddDisjunction([LocationEnum.SC_1.value, LocationEnum.RETURN_0.value])
  #routing.AddDisjunction([LocationEnum.SC_1.value, LocationEnum.RETURN_1.value])
  #routing.AddDisjunction([LocationEnum.SC_1.value, LocationEnum.SC_1_RETURN_1.value])
  #routing.AddDisjunction([LocationEnum.SC_1.value, LocationEnum.SC_2_RETURN_0.value])
  #routing.AddDisjunction([LocationEnum.PICKUP_2_LOANER.value, LocationEnum.PICKUP_2.value], 100000)
 ...
 # routing.AddDisjunction([LocationEnum.SC_1_TAKEIN_0.value], 10000)
  ...
  #routing.AddSoftSameVehicleConstraint([LocationEnum.SC_2_PROVIDE_LOANER_2.value, LocationEnum.PICKUP_2_LOANER.value], 10000)
  ...
  #routing.solver().Add(routing.VehicleVar(LocationEnum.SC_1_PROVIDE_LOANER_2.value) == routing.VehicleVar(LocationEnum.PICKUP_2_LOANER.value))
  #routing.solver().Add(routing.VehicleVar(LocationEnum.SC_2_PROVIDE_LOANER_2.value) == routing.VehicleVar(LocationEnum.PICKUP_2_LOANER.value))


  #routing.AddPickupAndDelivery(LocationEnum.PICKUP_2_LOANER.value, LocationEnum.PICKUP_2.value) # No effect?!?!
  #routing.solver().Add(routing.VehicleVar(LocationEnum.PICKUP_2_LOANER.value) == routing.VehicleVar(LocationEnum.PICKUP_2.value))

  #routing.AddPickupAndDelivery(LocationEnum.SC_2_PROVIDE_LOANER_2.value, LocationEnum.SC_1_TAKEIN_2.value)
  #routing.AddPickupAndDelivery(LocationEnum.SC_2_PROVIDE_LOANER_2.value, LocationEnum.SC_2_TAKEIN_2.value)
  ...
  #routing.AddPickupAndDelivery(LocationEnum.SC_1_PROVIDE_LOANER_2.value, LocationEnum.PICKUP_2_LOANER.value)
  #routing.AddPickupAndDelivery(LocationEnum.SC_2_RETURN_0.value, LocationEnum.RETURN_0.value)
  #routing.solver().Add(routing.CumulVar(LocationEnum.SC_2_RETURN_0.value, "Time") <= routing.CumulVar(LocationEnum.RETURN_0.value, "Time"))
  #routing.solver().Add(routing.VehicleVar(LocationEnum.SC_2_RETURN_0.value) == routing.VehicleVar(LocationEnum.RETURN_0.value))
  #routing.solver().Add(routing.CumulVar(LocationEnum.SC_2_PROVIDE_LOANER_2.value, "Time") <= routing.CumulVar(LocationEnum.PICKUP_2_LOANER.value, "Time"))
  #routing.solver().Add(routing.VehicleVar(LocationEnum.SC_2_PROVIDE_LOANER_2.value) == routing.VehicleVar(LocationEnum.PICKUP_2_LOANER.value))

  routing.AddSoftSameVehicleConstraint([LocationEnum.SC_1_PROVIDE_LOANER_2.value, LocationEnum.PICKUP_2_LOANER.value],2000)
  routing.AddSoftSameVehicleConstraint([LocationEnum.SC_2_PROVIDE_LOANER_2.value, LocationEnum.PICKUP_2_LOANER.value], 2000)
  routing.AddSoftSameVehicleConstraint([LocationEnum.PICKUP_2_LOANER.value, LocationEnum.SC_1_TAKEIN_2.value], 2000)
  routing.AddSoftSameVehicleConstraint([LocationEnum.PICKUP_2_LOANER.value, LocationEnum.SC_2_TAKEIN_2.value], 2000)
  routing.ApplyLocksToAllVehicles([[LocationEnum.SC_1_RETURN_1.value, LocationEnum.RETURN_1.value], [LocationEnum.SC_2_RETURN_0.value, LocationEnum.RETURN_0.value]], False);
  routing.AddSoftSameVehicleConstraint([LocationEnum.SC_1_RETURN_1.value, LocationEnum.RETURN_1.value], 10000)
  routing.AddSoftSameVehicleConstraint([LocationEnum.SC_2_RETURN_0.value, LocationEnum.RETURN_0.value], 10000)

  #routing.AddPickupAndDelivery(LocationEnum.SC_1_TAKEIN_0.value, LocationEnum.SC_1_RETURN_1.value)

  # #v0_default_node_idx = routing.NodeToIndex(11)
  #routing.solver().Add(routing.VehicleVar(LocationEnum.V0_DEFAULT.value) == routing.VehicleVar(routing.Start(0)))
...
#   routing_enums_pb2.FirstSolutionStrategy.ALL_UNPERFORMED)
  ...
  #print("Solver active variables: ", routing.ActiveVar())
