...
def create_distance_callback(data):
    ...
    # _distances[LocationEnum.SC_1.value][LocationEnum.RETURN_0.value] = 1000
    ...
    _distances[LocationEnum.PICKUP_0.value][LocationEnum.SC_1_RETURN.value] = 40
    ...
    _distances[LocationEnum.RETURN_0.value][LocationEnum.SC_1_TAKEIN.value] = 1000
    _distances[LocationEnum.RETURN_0.value][LocationEnum.SC_1_RETURN.value] = 1000
