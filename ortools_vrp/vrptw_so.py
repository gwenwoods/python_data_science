...
class LocationEnum(Enum):
    ...
    PICKUP_2 = 18
    RETURN_0 = 19
    RETURN_1 = 20 # WEN TODO: problem is need to go back to depot in the middle of the route, how about refuel
...
def create_data_model():
    ...
    demands = [0, -1, -1, -1, 1, -1,
               0, -1, -1, -1, 1, -1,
               0, 0, 0,
               1, 1, -1, 1,  # pick up with loaner has demand 0 in the customer location. Because we unload 1 and load 1
               -1, -1]
...
def create_distance_callback(data):
    ...
    _distances[LocationEnum.SC_1.value][LocationEnum.PICKUP_2.value] = 0
    ...
    _distances[LocationEnum.SC_1_TAKEIN_0.value][LocationEnum.PICKUP_2.value] = 1000
    ...
    _distances[LocationEnum.SC_1_TAKEIN_1.value][LocationEnum.PICKUP_2.value] = 1000
    ...
    _distances[LocationEnum.SC_1_TAKEIN_2.value][LocationEnum.PICKUP_2.value] = 1000
    ...
    _distances[LocationEnum.SC_1_PROVIDE_LOANER_2.value][LocationEnum.PICKUP_2.value] = 10
    ...
    _distances[LocationEnum.SC_1_RETURN_1.value][LocationEnum.PICKUP_2.value] = 1000
...
#-------
    ...
    _distances[LocationEnum.SC_2.value][LocationEnum.PICKUP_2.value] = 1000
    ...
    _distances[LocationEnum.SC_2_TAKEIN_0.value][LocationEnum.PICKUP_2.value] = 1000
    ...
    _distances[LocationEnum.SC_2_TAKEIN_1.value][LocationEnum.PICKUP_2.value] = 1000
    ...
    _distances[LocationEnum.SC_2_TAKEIN_2.value][LocationEnum.PICKUP_2.value] = 1000
    ...
    _distances[LocationEnum.SC_2_PROVIDE_LOANER_2.value][
        LocationEnum.PICKUP_2.value] = 10  # need to get loaner car first
    ...
    _distances[LocationEnum.SC_2_RETURN_0.value][LocationEnum.PICKUP_2.value] = 1000
    ...
    _distances[LocationEnum.V0_DEFAULT.value][LocationEnum.PICKUP_2.value] = 1000
    ...
    _distances[LocationEnum.V1_DEFAULT.value][LocationEnum.PICKUP_2.value] = 1000
    ...
    _distances[LocationEnum.V2_DEFAULT.value][LocationEnum.PICKUP_2.value] = 1000
    ...
    _distances[LocationEnum.PICKUP_0.value][LocationEnum.PICKUP_2.value] = 1000
    ...
    _distances[LocationEnum.PICKUP_1.value][LocationEnum.PICKUP_2.value] = 1000
    ...
    _distances[LocationEnum.PICKUP_2_LOANER.value][LocationEnum.SC_1_TAKEIN_2.value] = 1000
    ...
    _distances[LocationEnum.PICKUP_2_LOANER.value][LocationEnum.SC_2_TAKEIN_2.value] = 1000
    ...
    _distances[LocationEnum.PICKUP_2_LOANER.value][LocationEnum.PICKUP_2.value] = 5
    ...
    _distances[LocationEnum.RETURN_0.value][LocationEnum.PICKUP_2.value] = 1000
    ...
    _distances[LocationEnum.RETURN_1.value][LocationEnum.PICKUP_2.value] = 1000
...
def main():
 ...
 # routing.AddDisjunction([LocationEnum.SC_1_TAKEIN_0.value], 10000)
  ...
  #routing.AddPickupAndDelivery(LocationEnum.SC_1_PROVIDE_LOANER_2.value, LocationEnum.PICKUP_2.value)
  #routing.AddPickupAndDelivery(LocationEnum.SC_2_PROVIDE_LOANER_2.value, LocationEnum.PICKUP_2.value)
