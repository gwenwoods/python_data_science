...
class LocationEnum(Enum):
    ...
    PICKUP_1 = 12
    RETURN_0 = 13
    RETURN_1 = 14 # WEN TODO: problem is need to go back to depot in the middle of the route, how about refuel
...
#-------
    ...
    _distances[LocationEnum.V0_DEFAULT.value][LocationEnum.SC_1.value] = 1000
