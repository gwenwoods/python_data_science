...
class LocationEnum(Enum):
    ...
    PICKUP_1 = 9
    RETURN_0 = 10
    RETURN_1 = 11 # WEN TODO: problem is need to go back to depot in the middle of the route, how about refuel
...
def main():
  ...
  routing.AddDisjunction([LocationEnum.SC_1_TAKEIN_0.value,LocationEnum.SC_2_TAKEIN_0.value], 0)
  routing.AddDisjunction([LocationEnum.SC_1_TAKEIN_1.value,LocationEnum.SC_2_TAKEIN_1.value], 0)
  ...
  routing.AddDisjunction([LocationEnum.SC_2.value], 0)
